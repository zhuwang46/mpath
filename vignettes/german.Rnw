...
This document reproduces the data analysis presented in \cite{wang2014zinb}. In an effort to optimize the computing algorithms, the penalized regression can be slightly different. For a description of the theory behind
